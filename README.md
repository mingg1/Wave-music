# Wave music - Music around you 🎵

A music app for browsing music-related things such as songs, artists, and albums.
The application suggests songs according to the users' tastes. Users can create their own accounts to display their favorite artists, tracks, or albums.
<br> <br> 
By giving seed artists, tracks from users' favorites with genres, users can get suggested songs based on their favorites. The app also allows users to search for albums, artists, tracks, and users. It is possible to preview music for 30 seconds while browsing the app.
<br>
...
<span><br>(⚠️ Demo is out of service at the moment due to a huge change from Spotify API 🥲)</span>
...
- **Register / Login**
- **Search<br>**
  Users can search for tracks, artists, albums, and users.<br>
...
- **Track info<br>**
  On this page, users can see a list of similar tracks.<br>
...
- **Artist info<br>**
  On this page, users can see the artist's popular tracks, released albums, and similar artists.<br>
...
- **Album info<br>**
  On this page, users can see all the tracks in the album.
...
- **User profile <br>**
  ...
  Users can see their playlists and lists of favorite songs, artists, and albums.
...
- **DJ station**<br>
  Forum for sharing users' music tastes and stories. It is possible to leave comments on posts.
